...
public class Discoverer extends Thread {
    ...
    public void run() {
        try {
            ...
            Log.i("Discoverer", "run: I am here");
        } catch (IOException e) {
    ...
    private void sendDiscoveryRequest(DatagramSocket socket) throws IOException {
        ...
        socket.setTrafficClass(MAX_PRIORITY);
    ...
    private void listenForResponses(DatagramSocket socket) throws IOException {
        ...
        try {
            ...
            Log.i("Discoverer", "listenForResponses: " + packet.getAddress());
    ...
    private InetAddress getBroadcastAddress() throws IOException {
        ...
        Log.i("Discoverer", "getBroadcastAddress: " + InetAddress.getByAddress(quads));
